...
export default function SuperBrynLandingPage() {
  ...
  return (
    <div className=" font-sans bg-[#0a0714] text-white selection:bg-[#8352FD] selection:text-white">
      ...
      <main className="relative min-h-[70vh] pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden bg-linear-to-r from-[#140e2c] via-[#413c97] to-[#0A0714]">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 text-center flex flex-col items-center">
          ...
          Please log in to update the call analytics data. The current data shown is for demonstration purposes only.
          </p>

          <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
          <Link 
            href="#analytics"
            className="w-full cursor-pointer sm:w-auto bg-[#8B5CF6] hover:bg-[#7C3AED] text-white px-8 py-3.5 rounded-full font-medium transition-all flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(139,92,246,0.3)]"
          >
            Analyse Charts
      ...
      <section id="analytics" className="py-12 md:py-16 bg-white">
        <AnalyticsDashboard />
      </section>
    </div>
  );
